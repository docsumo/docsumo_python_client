...
class Docsumo:
    ...
    def documents_summary(self):
        ...
        url = "{}/api/{}/mew/apikey/documents/summary/".format(self.url, self.version)
        response = requests.request("GET", url, headers=self.headers)
        original_response = response.json()
        return original_response
    ...
    def upload_file_custom(
        self, file_url, file_name, file_type, doc_title, user_doc_id=None
    ):
        """
        Uploads valid documents for processing.
        Args:
            file_url:``str``
                Link to file or base 64 encoding
            file_name:``str``
                Title of the file
            file_type:``str``
                base64 if file is base64 encoded else url
            doc_title:``str``
                Document title. You can get title using ``user_detail_credit_limit``.
            user_doc_id: ``str``
                Document id given by user
        ...
        url = "{}/api/{}/eevee/apikey/upload/custom/".format(self.url, self.version)
        headers = {"apikey": self.apikey}
    ...
    def doc_detail_single(self, doc_id):
        """
        Uploads valid documents for processing.
        Args:
            doc_id:``str``
                Unique document id of a document
        Returns:
            Details of document specified by doc_id : ``dict``
...

                {
                    "data": {
                        "document": {
                            ...
                            "doc_id": "5eb50cb4b6814bbd83fd4eb3c43978bf",
                            "pages": [
                                {
                                    "id": 1,
                                    "image": {
                                        "height": 2339,
                                        "url": "https://testing-docsumo-documents.s3.amazonaws.com/5fcf257f72ccee82d405e881/97082/5eb50cb4b6814bbd83fd4eb3c43978bf_image.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAI2SXTX7KMYAKIFCA%2F20210120%2Fap-south-1%2Fs3%2Faws4_request&X-Amz-Date=20210120T055014Z&X-Amz-Expires=43200&X-Amz-SignedHeaders=host&X-Amz-Signature=f4b6ee310ebdd8380d776c124df79f6ce4a9a772c423545bbf175c6d2a3c69d7",
                                        "width": 1653
                                    }
                                }
                            ],
                            "preview_image": {
                                "height": 1169,
                                "url": "https://testing-docsumo-documents.s3.ap-south-1.amazonaws.com/5fcf257f72ccee82d405e881/97082/5eb50cb4b6814bbd83fd4eb3c43978bf_thumbnail.jpg",
                                "width": 826
                            },
                            "type": "invoice",
                            "type_title": "Invoice",
                            "uploaded_by": {
                                "avatar_url": "",
                                "email": "bs_check@apptesting.com",
                                "full_name": "Janardan Banjara",
                                "user_id": "5fcf257f72ccee82d405e881"
                            },
                            "user_id": "5fcf257f72ccee82d405e881"
                        }
                    },
        ...
        """
        url = "{}/api/{}/eevee/apikey/documents/detail/{}/".format(
            self.url, self.version, doc_id
        )
        headers = {"apikey": self.apikey}
